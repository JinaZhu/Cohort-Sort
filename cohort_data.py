...
def unique_houses(filename):
    ...
    for line in file:
        line = line.rstrip()
        seperate_into_list = line.split('|')

        #if statement that check the length of seperate into list and see if it greater or = to 3
            # if your seperated list is index of two, add the student to the set
        if len(seperate_into_list) >= 3:
            if len(seperate_into_list[2])>=2:
                houses.add(seperate_into_list[2])
                #print(houses)
...
def sort_by_cohort(filename):
    ...
    # if the cohort is winter..... add it to the cohort list
    ...
    for line in file:
        line = line.rstrip()
        seperate_into_list = line.split('|')
        #if (seperate_into_list[4]) != "G" or (seperate_into_list[4]) != "I":
            # all_students.append(seperate_into_list[0] +" " + seperate_into_list[1])
        if(seperate_into_list[4]) == "Winter 2016":
            winter_16.append(seperate_into_list[0] +" " + seperate_into_list[1])
        if(seperate_into_list[4]) == "Summer 2016":
            summer_16.append(seperate_into_list[0] +" " + seperate_into_list[1])
        if(seperate_into_list[4]) == "Spring 2016":
            spring_16.append(seperate_into_list[0] +" " + seperate_into_list[1])
        if(seperate_into_list[4]) == "Fall 2015":
            fall_15.append(seperate_into_list[0] +" " + seperate_into_list[1])
        if(seperate_into_list[4]) == "G":
            ghosts.append(seperate_into_list[0] +" " + seperate_into_list[1])
...
def hogwarts_by_house(filename):
    ...
    for line in file:
        ...
        if(seperate_into_list[2]) == "Dumbledore's Army":
            dumbledores_army.append(seperate_into_list[1])
        if(seperate_into_list[2]) == "Gryffindor":
            gryffindor.append(seperate_into_list[1])
        if(seperate_into_list[2]) == "Hufflepuff":
            hufflepuff.append(seperate_into_list[1])
        if(seperate_into_list[2]) == "Ravenclaw":
            ravenclaw.append(seperate_into_list[1])
        if(seperate_into_list[2]) == "Slytherin":
            slytherin.append(seperate_into_list[1])
        if(seperate_into_list[-1]) == "G":
            ghosts.append(seperate_into_list[1])
        if(seperate_into_list[-1]) == "I":
            instructors.append(seperate_into_list[1])
...
def all_students_tuple_list(filename):
    ...
    for line in file:
        ...
        if (seperate_into_list[2]) != "":
            tuple_student = tuple(seperate_into_list)
            student_list.append(tuple_student)
...
def find_house_members_by_student_name(student_list):
    ...
    #     find_house = seperate_into_list[2]
